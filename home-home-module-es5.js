...
var HomePage = /** @class */ (function () {
    function HomePage(http, sanitizer) {
        this.http = http;
        this.sanitizer = sanitizer;
    }
    HomePage.prototype.getMap = function () {
        var _this = this;
        var url = 'https://esb-hom.trt5.jus.br/justiceiros/service/healthcheck';
        ...
        this.http.get(url, null).toPromise().then(function (response) {
            var novoResponse = response;
            ...
            reader.onloadend = function () {
                _this.mapUrl = reader.result;
                console.log(_this.mapUrl);
            };
        });
    };
    HomePage.prototype.sanitize = function (url) {
        //return url;
